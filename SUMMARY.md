...
* Java基础
    * [clone的浅度克隆和深度克隆](notes/java基础/clone的浅度克隆和深度克隆.md)
	* [hash() 在各个场景下的实现](notes/java基础/hash() 在各个场景下的实现.md)
	* [Java中的String为什么是不可变](notes/java基础/Java中的String为什么是不可变.md)
	* [Java到底是值传递还是引用传递](notes/java基础/Java到底是值传递还是引用传递.md)
	* [Java基础](notes/java基础/Java基础.md)
	* [Java异常总结](notes/java基础/Java异常总结.md)
	* [jdk8新特性](notes/java基础/jdk8新特性.md)
	* [NIO](notes/java基础/NIO.md)
	* [string](notes/java基础/string.md)
	* [ThreadLocal](notes/java基础/ThreadLocal.md)
	* [为什么不建议使用Executors创建线程池](notes/java基础/为什么不建议使用Executors创建线程池.md)
	* [初始化执行顺序](notes/java基础/初始化执行顺序.md)
    ...
    * 集合
		...
		* [hashMap1.8](notes/java基础/集合/hashMap1.8.md)
		* [面试题](notes/java基础/集合/面试题.md)
* JVM
    * [gc过程](notes/jvm/gc过程.md)
	* [Java内存区域（运行时数据区域）和内存模型](notes/jvm/Java内存区域（运行时数据区域）和内存模型.md)
...
* mysql
	...
	* [MyISAM与InnoDB 的区别](notes/mysql/MyISAM与InnoDB 的区别.md)
	* [MySQL 共享锁与排他锁](notes/mysql/MySQL 共享锁与排他锁.md)
	* [mysql 的存储引擎介绍](notes/mysql/mysql 的存储引擎介绍.md)
	* [MySQL之Explain输出分析](notes/mysql/MySQL之Explain输出分析.md)
...
* kafka
    * [kafka使用过程问题](notes/kafka/kafka使用过程问题.md)
	* [kafka基本概念](notes/kafka/kafka基本概念.md)
	* [kafka扩容](notes/kafka/kafka扩容.md)
	* [kafka负载均衡](notes/kafka/kafka负载均衡.md)
	* [leader选举](notes/kafka/leader选举.md)
	* [MQ基本概念](notes/kafka/MQ基本概念.md)
	* [保证幂等性](notes/kafka/保证幂等性.md)
	* [保证消费顺序性](notes/kafka/保证消费顺序性.md)
	* [保证高可用性](notes/kafka/保证高可用性.md)
	* [解决消息丢失问题](notes/kafka/解决消息丢失问题.md)
	* [设计一个消息队列](notes/kafka/设计一个消息队列.md)
* redis
	...
	* [Redis的线程模型](notes/redis/Redis的线程模型.md)
...
* 分布式
    ...
    * 短链接
		...
		* [短链接系统的设计](notes/分布式/短链接/短链接系统的设计.md)
    * 限流
        * 解决方案
            * [限流方案](notes/分布式/限流/解决方案/限流方案.md)
* 数据库中间件
    * [mycat高可用数据库集群](notes/数据库中间件/mycat高可用数据库集群.md)
	* [ShardingSphere](notes/数据库中间件/ShardingSphere.md)
* 操作系统
    * [IO](notes/操作系统/IO.md)
...
* 计算机网络
    * [计算机网络基础](notes/计算机网络/计算机网络基础.md)
    * [协议](notes/计算机网络/协议.md)
    * HTTP
        * [HTTP协议](notes/计算机网络/HTTP/HTTP协议.md) 
        * [HTTP的长连接与短连接](notes/计算机网络/HTTP/HTTP的长连接与短连接.md)
    ...
    * TCP
		...
		* [TCP协议数据传输](notes/计算机网络/TCP/TCP协议数据传输.md)
		* [TCP的三次握手](notes/计算机网络/TCP/TCP的三次握手.md)
		* [TCP的四次挥手](notes/计算机网络/TCP/TCP的四次挥手.md)
    * Websocket
