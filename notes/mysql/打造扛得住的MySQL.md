...
![](../image/mysql_h_11.png)    



2. 大表对DDL的影响

![](../image/mysql_h_12.png)    
...
![](../image/mysql_h_22.png)  



![](../image/mysql_h_23.png)  
...
消耗数据获取SQL   
![](../image/mysql_h_47.png)  

格式大致与profile一致  
![](../image/mysql_h_48.png)  
...
如何修改大表的结构  
方案：![](../image/mysql_h_49.png)  

如何优化 not in 和 <> 查询  
方案：![](../image/mysql_h_50.png)  
...
![](../image/mysql_h_51.png)  

2. 把一个库中的表分离到不同的数据库中
![](../image/mysql_h_52.png)   

## 8.2 数据库分片前的准备
对一个库中的相关表进行水平拆分到不同实例的数据库中。
![](../image/mysql_h_53.png)   
