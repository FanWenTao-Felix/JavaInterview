HTTP（HyperText Transfer Protocol，超文本传输协议）是应用层协议，HTTP是一种协议规范，为真正通过HTTP协议进行通信的HTTP的实现程序提供了规范标准。
...
![](../../image/up-080aeec9ed5804b36a8d0afdae2238ef915.png)
...
cookie 数据存放在客户端的浏览器上，session数据放在服务器上。
